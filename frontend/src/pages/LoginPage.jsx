          ...
          <div className="w-full flex flex-col md:flex-row h-full">
            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-blue-500/30">
              <div className="w-full max-w-md 
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-2">Chào mừng</h2>
                  <p className="text-gray-200">Đăng nhập để kết nối với tài khoản của bạn</p>
                </div>
                ...
                <div className="mt-6 text-center">
                  <Link to="/signup" className="auth-link text-indigo-100 hover:text-indigo-200">
            ...
            <div className="hidden md:w-1/2 md:flex items-center justify-center p-6 bg-gradient-to-bl from-blue-900/30 to-purple-900/20">
              <div>
                ...
                />
                <div className="mt-6 text-center">
                  <h3 className="text-xl font-medium text-purple-400">Kết nối mọi lúc mọi nơi</h3>
